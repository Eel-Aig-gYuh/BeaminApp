...
import com.example.ubercus.SplashScreenDriverActivity;
import com.example.ubercus.Utils.DriverUtils;
...
import com.example.ubercus.databinding.ActivityDriverHomeBinding;
...
public class DriverHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(binding.appBarDriHome.driverToolbar);

        drawer = binding.driverDrawerLayout;
        navigationView = binding.driverNavView;
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_dri_home);
                                        ...
                                        if (task.isSuccessful()) {
                                            avatarFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                ...
                                                public void onSuccess(Uri uri) {
                                                    ...
                                                    DriverUtils.updateUser(drawer, updateData);
                                                }
                                            });
                                        }
                                    }
    ...
    private void init() {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            if (item.getItemId() == R.id.nav_sign_out) {
                ...
                builder.setTitle("sign_out")
                        ...
                        .setPositiveButton("SIGN OUT", (dialog, which) -> {
                            ...
                            Intent intent = new Intent(DriverHomeActivity.this, ChooseRole.class);
            ...
            if (item.getItemId() == R.id.nav_setting){
                Intent intent = new Intent(DriverHomeActivity.this, DriverSettingActivity.class);
                startActivity(intent);
            }

            // lich su giao dich
            if (item.getItemId() == R.id.nav_history){
                Intent intent = new Intent(DriverHomeActivity.this, HistoryActivity.class);
                startActivity(intent);
            }
            return true;
        });
        ...
        if (Common.currenDriver != null && Common.currenDriver.getAvatar() != null &&
                !TextUtils.isEmpty(Common.currenDriver.getAvatar())) {
            Glide.with(this)
                    .load(Common.currenDriver.getAvatar())
                    .into(img_avatar);
        }
    ...
    public boolean onSupportNavigateUp() {
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_dri_home);
